# Webex Device Assistant - Architecture and Operations Guide
...
- `GET /admin-page/manuals/ARCHITECTURE_CURRENT.md`
  - Markdown source for this guide.
- `GET /admin-page/manuals/{ARCHITECTURE.md|INSTALL.md|USER_MANUAL.md|MANUAL_KO.md}`
  - Existing top-level manuals.
...
- `/admin-page/manuals/ARCHITECTURE_CURRENT.md`
