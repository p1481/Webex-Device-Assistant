...
class OllamaProvider:
    ...
    def _normalize_display_mode(self, raw_mode: str) -> DisplayMode | None:
        ...
        aliases = {
            ...
            "dual": DisplayMode.DUAL,
            "dual-presentation-only": DisplayMode.DUAL_PRESENTATION_ONLY,
            "dual presentation only": DisplayMode.DUAL_PRESENTATION_ONLY,
            "dual presentation-only": DisplayMode.DUAL_PRESENTATION_ONLY,
            "dual-presentation only": DisplayMode.DUAL_PRESENTATION_ONLY,
            "dualpresentationonly": DisplayMode.DUAL_PRESENTATION_ONLY,
            "triple": DisplayMode.TRIPLE,
            "triple-presentation-only": DisplayMode.TRIPLE_PRESENTATION_ONLY,
            "triple presentation only": DisplayMode.TRIPLE_PRESENTATION_ONLY,
            "triple presentation-only": DisplayMode.TRIPLE_PRESENTATION_ONLY,
            "triple-presentation only": DisplayMode.TRIPLE_PRESENTATION_ONLY,
