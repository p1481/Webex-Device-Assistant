...
- `ADMIN_COOKIE_SECRET`: HMAC key for admin UI session cookies (required in real mode). See [docs/MIGRATION_ADMIN_COOKIE_SECRET.md](docs/MIGRATION_ADMIN_COOKIE_SECRET.md).
